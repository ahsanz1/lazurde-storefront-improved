...
module.exports = {
  ...
  collectCoverageFrom: [
    ...
    '!components/common/instagram-flow/instagram-page-detail/*.{js,jsx,tsx,ts}',
    '!components/common/instagram-flow/multiple-product-detail/single-product-card.tsx',
    '!components/common/account-information/index.{js,jsx,tsx,ts}',
    '!components/common/storeLocator/**/*.{js,jsx,tsx,ts}', // TEMPORARY TILL DEVELOPMENT IS COMPLETED
    '!components/common/checkout/**/*.{js,jsx,tsx,ts}', // TEMPORARY TILL DEVELOPMENT IS COMPLETED
  ],
  setupFiles: ['./setup.js']
}

...
const text =
  "Our jewelry builds on a legacy of over 180 years of expert craftsmanship with beautifully designed necklaces and pendants, bracelets, rings, and more.Our newest jewlery showcases L’azurde’s creativity and unparalleled design at its best.";
const cardArray = [
  {
    cardTitle: "Necklaces",
    cardImage: {
...
describe("PLP category", () => {
  ...
  test("plp array testing", () => {
    render(
      <ContextProvider>
        <PLPCategory backgroundColor={color} />
      </ContextProvider>
    );

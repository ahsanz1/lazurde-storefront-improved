...
const LazurdeProductListingPage: FC<ProductListingPageProps> = ({
  ...
  return (
    <>
      <BrPage
        configuration={{ ...configuration, httpClient: axios, NBRMode: true }}
        mapping={{
          ...brComponentMapping,
      ...
      >
        ...
        {/* <SkipToContentButton> */}
        <Header showStickyHeader={isCollection} />
        {/* <script
            async
...
export const getServerSideProps: GetServerSideProps = async ({
        ...
        component?.getChildren()?.find((component) => {
          if (component?.getName() === "container") {
            component?.getChildren()?.find((component: any) => {
              if (component?.getLabel() === "Collection") {
                isFromCMS = true;
                isCollection = true;
                return;
              }
              if (component?.getLabel() === "Product Grid") {
                ...
                if (path.includes("love-engagement")) {
                  isFromCMS = false;
                  return;
                }
                isFromCMS = true;
  ...
  if (path.includes("lab-grown-diamonds")) {
    return {
      props: {
        configuration,

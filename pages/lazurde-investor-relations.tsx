...
const CGIRPage: FC<any> = ({ configuration, page, host, locale }) => {
  const { investorRelation } = seoForStaticPages(locale);
  ...
  return (
    <React.Fragment key={brConfig?.endpoint}>
      ...
      >
        <HeaderSEO
          host={host}
          staticSeoData={investorRelation?.[lang]}
          locale={locale}
        />
        <BloomreachOtherPixel pageTitle="Investor Relations" pageType="other" />
        {/* <SkipToContentButton> */}
        <Header></Header>
        ...
        <main id="content" tabIndex={-1}>
          ...
          >
            ...
            <DynamicTermsAndConditions locale={locale} isCgirPage={true} />
          </AnimationWrapper>
        </main>
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  ...
  return {
    props: {
      ...
      host: pageProps?.host || "",
      referer: `https://www.lazurde.com/${locale}/lazurde-investor-relations`,
    },
  };
};

  ...
  return (
    <React.Fragment key={brConfig?.endpoint}>
      ...
      >
        ...
        <BloomreachOtherPixel pageTitle="Store Locations" pageType="other" />
        {/* <SkipToContentButton> */}
        <Header></Header>
...
//   configuration = buildConfiguration("/store-locations", currentLocale);
//   let page = null;
//   try {
...
//       host: pageProps?.host || "",
//       referer: `https://www.lazurde.com/${locale}/store-locations`,
//     },
//   };
// };

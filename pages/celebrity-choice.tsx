...
const CelebrityChoicePage: FC<any> = ({
  configuration,
  page,
  host,
  locale,
...
export default CelebrityChoicePage;
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  ...
  configuration = buildConfiguration("/celebrity-choice", currentLocale);
  let page = null;
  try {
  ...
  return {
    props: {
      ...
      host: pageProps?.host || "",
      referer: `https://www.lazurde.com/${locale}/celebrity-choice`,
    },
  };
};
